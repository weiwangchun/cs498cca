...
\begin{table}[htbp!]
  \centering
  \caption{In-sample Confusion Matrix}
    \begin{tabular}{clrrr}
...
\end{table}%
	...
	\begin{figure*}[tp]
	\includegraphics[width=\textwidth]{insample2.png}
	\includegraphics[width=\textwidth]{outofsample2.png}
	\caption{Training and Test set Profit and Loss}
	\end{figure*}
